    ...
    <div className="w-full flex flex-col-reverse lg:flex-row gap-14 justify-between items-center -z-10">
      <div className="flex flex-col gap-2 w-full lg:w-4/5">
        ...
        <p className="text-base text-gray-800 dark:text-gray-300 w-full">
          ...
          React.js, TypeScript, and modern front-end technologies, with a strong
          focus on implementing best practices, optimizing performance, and
          ensuring maintainability. Experienced in collaborating with
          ...
          ahead of emerging industry trends to create user-centric, high-quality
          products.
        </p>
      </div>
